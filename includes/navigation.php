...
$modules = [
    ...
    ['label' => 'Payments', 'page' => 'payments', 'url' => '#', 'icon' => '💳'],
    ['label' => 'Customers', 'page' => 'customers', 'url' => 'customers.php', 'icon' => '👥'],
    ['label' => 'Products', 'page' => 'products', 'url' => 'products.php', 'icon' => '🛢'],
    ['label' => 'Inventory', 'page' => 'inventory', 'url' => '#', 'icon' => '📦'],
    ['label' => 'Reports', 'page' => 'reports', 'url' => '#', 'icon' => '📈'],
    ['label' => 'Users', 'page' => 'users', 'url' => 'admin_users.php', 'icon' => '👤'],
    ['label' => 'Settings', 'page' => 'settings', 'url' => '#', 'icon' => '⚙️'],
];
?>
